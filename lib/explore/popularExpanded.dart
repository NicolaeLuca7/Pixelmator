...
class PopularExpanded extends StatefulWidget {
  User1 user1;
  PopularExpanded({super.key, required this.user1});

  @override
  State<PopularExpanded> createState() => _PopularExpandedState(user1: user1);
}

class _PopularExpandedState extends State<PopularExpanded> {
  User1 user1;
  _PopularExpandedState({required this.user1});
